...
Partial Class ContactUs
    ...
    Protected Sub btn_send_Click(sender As Object, e As EventArgs) Handles btn_send.Click
        ...
        sendersEmail = tb_yourEmail.Text.ToString() 'capture the senders email from the textbox
        sendersMessage = tb_yourMessage.Text.ToString().Replace(Environment.NewLine, "<br />")   ' get the text from the message textbox keep text box formatting by replacing new lines (returns) with <br/>
