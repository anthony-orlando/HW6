<%@ Page Language="VB" AutoEventWireup="false" CodeFile="xNewRecipe.aspx.vb" Inherits="NewRecipe" %>
...
<body>
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="recipe_Id" DataSourceID="SqlDataSource1" DefaultMode="Insert" Height="50px" Width="125px">
            <Fields>
